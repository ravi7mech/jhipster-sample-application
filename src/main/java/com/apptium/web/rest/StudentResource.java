...
import com.apptium.domain.Student;
import com.apptium.repository.StudentRepository;
...
/**
 * REST controller for managing {@link com.apptium.domain.Student}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class StudentResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSampleApplicationStudent";
