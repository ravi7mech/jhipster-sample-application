...
/**
 * REST controller for managing {@link com.apptium.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "orderMgmtCustomer";
    ...
    public List<Customer> getAllCustomers(@RequestParam(required = false) String filter) {
        if ("industry-is-null".equals(filter)) {
            log.debug("REST request to get all Customers where industry is null");
            return customerService.findAllWhereIndustryIsNull();
        }
