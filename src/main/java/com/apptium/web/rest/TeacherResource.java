...
import com.apptium.repository.TeacherRepository;
...
/**
 * REST controller for managing {@link com.apptium.domain.Teacher}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TeacherResource {
    ...
    private static final String ENTITY_NAME = "jhipsterSampleApplicationTeacher";
