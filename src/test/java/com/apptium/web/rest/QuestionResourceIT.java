...
import com.apptium.repository.QuestionRepository;
...
class QuestionResourceIT {
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question().title(DEFAULT_TITLE);
        return question;
    }
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question().title(UPDATED_TITLE);
        return question;
    }
    ...
    void putNewQuestion() throws Exception {
        ...
        updatedQuestion.title(UPDATED_TITLE);
